...
constexpr char PIR_SERVICE_UUID[] = "19B10000-E8F2-537E-4F6C-D104768A1214";
constexpr char PIR_STATE_CHAR_UUID[] = "19B10001-E8F2-537E-4F6C-D104768A1214";

BLEService pirService(PIR_SERVICE_UUID);
BLEByteCharacteristic pirStateCharacteristic(PIR_STATE_CHAR_UUID, 
    BLERead | BLENotify);
...
void setup() {
    ...
    Serial.println(PIR_SERVICE_UUID);
    Serial.print(F("[BOOT] Characteristic UUID: "));
    Serial.println(PIR_STATE_CHAR_UUID);
